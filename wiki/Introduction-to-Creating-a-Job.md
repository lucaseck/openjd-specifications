...
If you have not already read through [How Jobs Are Constructed](How-Jobs-Are-Constructed.md) and [How Jobs Are Run](How-Jobs-Are-Run.md)
...
1. [Toolchain Setup](Job-Intro-01-Toolchain-Setup.md)
2. [Starting with shell scripts](Job-Intro-02-Starting-With-Shell-Scripts.md)
...
3. [Creating a Job Template](Job-Intro-03-Creating-a-Job-Template.md)
    1. [Embed the scripts into a Job Template](Job-Intro-03-Creating-a-Job-Template.md#1-embed-the-scripts-into-a-job-template)
    2. [Parameterizing the template](Job-Intro-03-Creating-a-Job-Template.md#2-parameterizing-the-template)
    3. [Path Mapping](Job-Intro-03-Creating-a-Job-Template.md#3-path-mapping)
    4. [Adding Task Parallelism](Job-Intro-03-Creating-a-Job-Template.md#4-adding-task-parallelism)
4. [Ready for Production](Job-Intro-04-Ready-for-Production.md)
    1. [Condition testing using environments](Job-Intro-04-Ready-for-Production.md#1-conditional-testing-using-environments)
    2. [Adding host requirements](Job-Intro-04-Ready-for-Production.md#2-adding-host-requirements)
    3. [The final result](Job-Intro-04-Ready-for-Production.md#3-the-final-result)
